...
def create_eva_vit_g(img_size=256,patch_size=28,drop_path_rate=0.4,use_checkpoint=False,precision="fp16"):
    ...
    # cached_file = '/ailab/group/pjlab-smarthealth03/transfers_cpfs_test/wanglilong/data/model/torch/hub/checkpoints/eva_vit_g.pth'

    # print ('create_eva_vit_g: ', cached_file)
